...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($frase)) {
        ...
        $stmt = $pdo->prepare("
            INSERT INTO noemi_frases (frase, activo)
            VALUES (:frase, 1)
        ");
        ...
        if ($stmt->execute([
            ...
            $mensaje = mostrarAlerta('Frase guardada correctamente.', 'success');
        } else {
...
<main>
    <section>
        <div class="container">
            <h2>Frases de "Noemí dice"</h2>

            <?= $mensaje ?>

            <form method="post" class="formulario">

                <label>Crear una nueva frase de Noemí:</label>
